...
searchParams.add_argument('date_de_publication_debut', help='filtre de recherche sur la date de publication de l\'acte au format iso')
searchParams.add_argument('date_de_publication_fin', help='filtre de recherche sur la date de publication de l\'acte au format iso')
